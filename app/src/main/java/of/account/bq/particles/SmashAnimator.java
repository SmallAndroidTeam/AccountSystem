package of.account.bq.particles;
...
import of.account.bq.utils.Utils;
            ...
            for (int j = 0; j < col; j++) {
                ...
                switch (mStyle) {
                    ...
                    case STYLE_FLOAT_BOTTOM:
                        ...
                        break;
                    case RING:
                        mParticles[i][j] = new FloatParticle(FloatParticle.RING, point, color, mRadius, mRect, mEndValue, random, mHorizontalMultiple, mVerticalMultiple);
                        break;
                }
