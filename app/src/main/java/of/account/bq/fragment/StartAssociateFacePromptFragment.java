...
public class StartAssociateFacePromptFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_face_start_prompt, container, false);
        initViews(view);
...
//                        iv.setVisibility(View.GONE);
                        ...
                        MainActivity.fragmentreplace = new AssociateFaceFragment();
                        getFragmentManager()
                                .beginTransaction()
                                .addToBackStack(null)
